  ...
  <ul>
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <div class="moduleItemIntrotext">
	      ...
	      <?php if($params->get('itemImage') && isset($item->imageXLarge)): ?>
	      <a class="moduleItemImage" href="<?php echo $item->link; ?>" title="<?php echo JText::_('K2_CONTINUE_READING'); ?> &quot;<?php echo K2HelperUtilities::cleanHtml($item->title); ?>&quot;">
	      	<img src="<?php echo $item->imageXLarge; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($item->title); ?>"/>
	      </a>
	      <?php endif; ?>
		<?php if($params->get('itemTitle')): ?>
      	...
      	<?php if($params->get('itemIntroText')): ?>
      		<div class="wellcome_IntroText"><p><?php echo $item->introtext; ?></p></div>
      	<?php endif; ?>
      	<?php if($params->get('itemReadMore') && $item->fulltext): ?>
			<div class="wellcome_redmore"><a class="moduleItemReadMore" href="<?php echo $item->link; ?>">
